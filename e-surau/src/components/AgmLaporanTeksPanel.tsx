...
export const SEKSYEN_SU: Bahagian[] = [
  ...
  { kunci: "su_cabaran", tajuk: "B6.7 · Laporan SU — Cabaran", desc: "Ganti senarai cabaran lalai.", contoh: "cth: pendapatan bermusim, tunggakan khairat, kebergantungan kepada segelintir AJK…" },
  ...
  { kunci: "modul_esurau", tajuk: "B6.5 · Ringkasan Sistem e-Surau", desc: "Ganti ringkasan modul lalai (pilihan).", contoh: "cth: keahlian, khairat, kewangan, program, sewaan, staf, gaji, AGM, penajaan, bayaran…" },
